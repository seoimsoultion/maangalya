							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<img class="logo-default" alt="Porto" width="324" height="212" src="img/new_images/MAANGALYA-_New-Logo.jpg">
										<a href="demo-construction.html">
											<img class="logo-small" alt="Porto" width="131" height="48" src="img/new_images/MAANGALYA-_New-Logo.jpg">
										</a>
									</div>
								</div>
							</div>
