...
<div role="main" class="main">
                ...
                <div class="overflow-hidden mb-4 pb-3">
                  ...
                  <form role="form" class="needs-validation">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" required type="text"  placeholder="RERA Number ">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 font-weight-bold text-dark col-form-label form-control-label text-2 required">Company Name </label>
                        <div class="col-lg-8">
                            <input class="form-control" required type="text"  placeholder="Company Name">
                        </div>
                    </div>
                    <div class="form-group row">
  ...
  <input class="form-control" type="text" placeholder="Contact Number ">
                        ...
                        <div class="form-group row">
                        <label class="col-lg-4 font-weight-bold text-dark col-form-label form-control-label text-2">Contact Person Name</label>
                        <div class="col-lg-8">
