...
if ($_POST) {
   ...
   // $captcha = $_POST['g-recaptcha-response'];
    $subject = 'Enquiry from Maangalya Signature Microsite ';
    ...
    $message = '<table cellspacing="0" cellpadding="0" style="width:100%; border-bottom:1px solid #eee; font-size:12px; line-height:135%">
		...
		<tr align="center">
			<td colspan="3" style="text-align:center;">
				<img src="https://www.maangalyaprojects.com/maangalya-signature-apartments-in-jp-nagar/assets_files/logo.png">
			</td>
        </tr>
