...
<html> 
	...
	<head>
		...
		<title>Join Development | Maangalya Constructions | Maangalya Projects</title>	
		...
		<meta name="description" content="Joint Development: Maangalya Constructions is a top real estate company in Bangalore. Maangalya Builders are constantly looking to acquire and develop projects in Joint Venture.">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 order-1 order-lg-2">
                ...
                <div class="overflow-hidden mb-1">
                    ...
                    <h2 class="font-weight-normal text-7 mb-0 text-center">

                        <strong class="font-weight-extra-bold">&nbsp;</h2>
                        ...
                        <div class="box-content">
                            ...
                            <form role="form" class="" id="con">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">Message</label>
...
$("#saveInput").val("Please Wait");
        ...
        $.ajax({
            ...
            url: "joint-development-mail.php",
