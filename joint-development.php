            ...
            <div class="row">
                ...
                <div class="col-md-12 align-self-center order-1">
                    <ul class="breadcrumb breadcrumb-light d-block text-center">
                        <li><a href="#">Home</a></li>
                        <li class="active">JOINT DEVELOPMENT</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12 order-1 order-lg-2">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input class="form-control" required type="text"  placeholder="Your ID">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2 required">Customer Number </label>
                        <div class="col-lg-9">
                            <input class="form-control" required type="text"  placeholder="Customer Contact Number">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2 required">Customer Name </label>
                        <div class="col-lg-9">
  <input class="form-control" type="text" placeholder="Customer Name ">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2 required">Customer Email </label>
                        <div class="col-lg-9">
                            
                                                      <input class="form-control" required type="email" placeholder="Customer Email *">
                        </div>
                    </div>
                       <div class="form-group row">
                        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">Project</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">Notes</label>
                        <div class="col-lg-9">
