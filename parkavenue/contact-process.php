...
define("WEBMASTER_EMAIL", 'hamalton.xavier@gmail.com');

define("WEBMASTER_EMAIL2", 'karthik@imsolutions.mobi');
define("WEBMASTER_EMAIL3", 'hamalton@imsolutions.mobi');
...
if ($_POST) {
   ...
   // $captcha = $_POST['g-recaptcha-response'];
    $subject = 'Enquiry from Maangalya Park-Avenue Microsite ';
...
// Check fullname
  if (!$name || empty($name)) {
    ...
    $email_name = "Maangalya Park-Avenue";
    ...
    $message = '<table cellspacing="0" cellpadding="0" style="width:100%; border-bottom:1px solid #eee; font-size:12px; line-height:135%">
		...
		<tr align="center">
			<td colspan="3" style="text-align:center;">
				<img src="https://www.maangalyaprojects.com/parkavenue/img/logo.png">
			</td>
        </tr>
	...
	if ($result === false) {
     ...
     if ($result->success) {
      ...
      $values = [
          [$name, $email, $phone, $query, date('d-m-Y H:i'), 'Maangalya-Signature Microsite '],
      ];
